              ...
              Padding(
                ...
                child: SizedBox(
                    ...
                    child: TextFormField(
                      ...
                      controller: widget.car != null
                          ? null
                          : _model
                              .carMake, //Load bearing code for each of the inputs; this allows either the initial input or the controller to be used first. Both are needed
                      decoration: InputDecoration(
                          labelText: 'Make',
                          hintText:
                              'Toyota, Honda, etc.'), //the text that appears when the field is empty
                      style: TextStyle(fontSize: 18.0), //the size of the text
                      onSaved: (value) {
                        //when the submit button is pressed, the text in this field is saved to the _savedmake variable
                        _savedmake = value!;
                      },
                    )),
              ),
                ...
                child: SizedBox(
                    ...
                    child: TextFormField(
                      ...
                      controller: widget.car != null
                          ? null
                          : _model
                              .carTrim, //Load bearing code for each of the inputs; this allows either the initial input or the controller to be used first. Both are needed
                      decoration: InputDecoration(
                          labelText: 'Trim',
                          hintText:
                              'MyCar, TheBeast, etc.'), //the text that appears when the field is empty
                      style: TextStyle(fontSize: 18.0), //the size of the text
                      onSaved: (value) {
                        //when the submit button is pressed, the text in this field is saved to the _nickname variable
                        _savedname = value!;
                ...
                child: SizedBox(
                    ...
                    child: TextFormField(
                      ...
                      controller: widget.car != null
                          ? null
                          : _model
                              .carYear, //Load bearing code for each of the inputs; this allows either the initial input or the controller to be used first. Both are needed
                      decoration: InputDecoration(
                          labelText: 'Year',
                          hintText:
                              '2002, 2015, etc.'), //the text that appears when the field is empty
                      style: TextStyle(fontSize: 18.0), //the size of the text
                      inputFormatters: [
                ...
                child: SizedBox(
                    ...
                    child: TextFormField(
                      ...
                      controller: widget.car != null
                          ? null
                          : _model
                              .carMileage, //Load bearing code for each of the inputs; this allows either the initial input or the controller to be used first. Both are needed
                      decoration: InputDecoration(
                          labelText:
                ...
                child: SizedBox(
                    ...
                    child: TextFormField(
                      ...
                      controller: widget.car != null
                          ? null
                          : _model
                              .oilChanged, //Load bearing code for each of the inputs; this allows either the initial input or the controller to be used first. Both are needed
                      decoration: InputDecoration(
                          labelText:
                ...
                child: SizedBox(
                    ...
                    child: TextFormField(
                      ...
                      controller: widget.car != null
                          ? null
                          : _model
                              .oilInterval, //Load bearing code for each of the inputs; this allows either the initial input or the controller to be used first. Both are needed
                      decoration: InputDecoration(
                ...
                child: SizedBox(
                    ...
                    child: TextFormField(
                      ...
                      controller: widget.car != null
                          ? null
                          : _model
                              .transChanged, //Load bearing code for each of the inputs; this allows either the initial input or the controller to be used first. Both are needed
                      decoration: InputDecoration(
                          labelText:
                ...
                child: SizedBox(
                    ...
                    child: TextFormField(
                      ...
                      controller: widget.car != null
                          ? null
                          : _model
                              .transInterval, //Load bearing code for each of the inputs; this allows either the initial input or the controller to be used first. Both are needed
                      decoration: InputDecoration(
                ...
                child: SizedBox(
                    ...
                    child: TextFormField(
                      ...
                      controller: widget.car != null
                          ? null
                          : _model
                              .transFilterChanged, //Load bearing code for each of the inputs; this allows either the initial input or the controller to be used first. Both are needed
                      decoration: InputDecoration(
                          labelText:
                ...
                child: SizedBox(
                    ...
                    child: TextFormField(
                      ...
                      controller: widget.car != null
                          ? null
                          : _model
                              .transFilterInterval, //Load bearing code for each of the inputs; this allows either the initial input or the controller to be used first. Both are needed
                      decoration: InputDecoration(
                ...
                child: SizedBox(
                    ...
                    child: TextFormField(
                      ...
                      controller: widget.car != null
                          ? null
                          : _model
                              .brakeFluidChanged, //Load bearing code for each of the inputs; this allows either the initial input or the controller to be used first. Both are needed
                      decoration: InputDecoration(
                          labelText:
                ...
                child: SizedBox(
                    ...
                    child: TextFormField(
                      ...
                      controller: widget.car != null
                          ? null
                          : _model
                              .brakeFluidInterval, //Load bearing code for each of the inputs; this allows either the initial input or the controller to be used first. Both are needed
                      decoration: InputDecoration(
                ...
                child: SizedBox(
                    ...
                    child: TextFormField(
                      ...
                      controller: widget.car != null
                          ? null
                          : _model
                              .brakesChanged, //Load bearing code for each of the inputs; this allows either the initial input or the controller to be used first. Both are needed
                      decoration: InputDecoration(
                          labelText:
                ...
                child: SizedBox(
                    ...
                    child: TextFormField(
                      ...
                      controller: widget.car != null
                          ? null
                          : _model
                              .brakesInterval, //Load bearing code for each of the inputs; this allows either the initial input or the controller to be used first. Both are needed
                      decoration: InputDecoration(
                ...
                child: SizedBox(
                    ...
                    child: TextFormField(
                      ...
                      controller: widget.car != null
                          ? null
                          : _model
                              .sparksChanged, //Load bearing code for each of the inputs; this allows either the initial input or the controller to be used first. Both are needed
                      decoration: InputDecoration(
                          labelText:
                ...
                child: SizedBox(
                    ...
                    child: TextFormField(
                      ...
                      controller: widget.car != null
                          ? null
                          : _model
                              .sparksInterval, //Load bearing code for each of the inputs; this allows either the initial input or the controller to be used first. Both are needed
                      decoration: InputDecoration(
                ...
                child: SizedBox(
                    ...
                    child: TextFormField(
                      ...
                      controller: widget.car != null
                          ? null
                          : _model
                              .ffilterChanged, //Load bearing code for each of the inputs; this allows either the initial input or the controller to be used first. Both are needed
                      decoration: InputDecoration(
                          labelText:
                ...
                child: SizedBox(
                    ...
                    child: TextFormField(
                      ...
                      controller: widget.car != null
                          ? null
                          : _model
                              .ffilterInterval, //Load bearing code for each of the inputs; this allows either the initial input or the controller to be used first. Both are needed
                      decoration: InputDecoration(
                ...
                child: SizedBox(
                    ...
                    child: TextFormField(
                      ...
                      controller: widget.car != null
                          ? null
                          : _model
                              .afilterChanged, //Load bearing code for each of the inputs; this allows either the initial input or the controller to be used first. Both are needed
                      decoration: InputDecoration(
                          labelText:
                ...
                child: SizedBox(
                    ...
                    child: TextFormField(
                      ...
                      controller: widget.car != null
                          ? null
                          : _model
                              .afilterInterval, //Load bearing code for each of the inputs; this allows either the initial input or the controller to be used first. Both are needed
                      decoration: InputDecoration(
                ...
                child: SizedBox(
                    ...
                    child: TextFormField(
                      ...
                      controller: widget.car != null
                          ? null
                          : _model
                              .cabinAirFilterChanged, //Load bearing code for each of the inputs; this allows either the initial input or the controller to be used first. Both are needed
                      decoration: InputDecoration(
                          labelText:
                ...
                child: SizedBox(
                    ...
                    child: TextFormField(
                      ...
                      controller: widget.car != null
                          ? null
                          : _model
                              .cabinAirFilterInterval, //Load bearing code for each of the inputs; this allows either the initial input or the controller to be used first. Both are needed
                      decoration: InputDecoration(
                ...
                child: SizedBox(
                    ...
                    child: TextFormField(
                      ...
                      controller: widget.car != null
                          ? null
                          : _model
                              .timingBeltChanged, //Load bearing code for each of the inputs; this allows either the initial input or the controller be used first. Both are needed
                      decoration: InputDecoration(
                          labelText:
                ...
                child: SizedBox(
                    ...
                    child: TextFormField(
                      ...
                      controller: widget.car != null
                          ? null
                          : _model
                              .timingBeltInterval, //Load bearing code for each of the inputs; this allows either the initial input or the controller to be used first. Both are needed
                      decoration: InputDecoration(
                ...
                child: SizedBox(
                    ...
                    child: TextFormField(
                      ...
                      controller: widget.car != null
                          ? null
                          : _model
                              .driveBeltChanged, //Load bearing code for each of the inputs; this allows either the initial input or the controller to be used first. Both are needed
                      decoration: InputDecoration(
                          labelText:
                ...
                child: SizedBox(
                    ...
                    child: TextFormField(
                      ...
                      controller: widget.car != null
                          ? null
                          : _model
                              .driveBeltInterval, //Load bearing code for each of the inputs; this allows either the initial input or the controller to be used first. Both are needed
                      decoration: InputDecoration(
                ...
                child: SizedBox(
                    ...
                    child: TextFormField(
                      ...
                      controller: widget.car != null
                          ? null
                          : _model
                              .waterPumpChanged, //Load bearing code for each of the inputs; this allows either the initial input or the controller to be used first. Both are needed
                      decoration: InputDecoration(
                          labelText:
                ...
                child: SizedBox(
                    ...
                    child: TextFormField(
                      ...
                      controller: widget.car != null
                          ? null
                          : _model
                              .waterPumpInterval, //Load bearing code for each of the inputs; this allows either the initial input or the controller to be used first. Both are needed
                      decoration: InputDecoration(
                ...
                child: SizedBox(
                    ...
                    child: TextFormField(
                      ...
                      controller: widget.car != null
                          ? null
                          : _model
                              .fuelPumpChanged, //Load bearing code for each of the inputs; this allows either the initial input or the controller to be used first. Both are needed
                      decoration: InputDecoration(
                          labelText:
                ...
                child: SizedBox(
                    ...
                    child: TextFormField(
                      ...
                      controller: widget.car != null
                          ? null
                          : _model
                              .fuelPumpInterval, //Load bearing code for each of the inputs; this allows either the initial input or the controller to be used first. Both are needed
                      decoration: InputDecoration(
                ...
                child: SizedBox(
                    ...
                    child: TextFormField(
                      ...
                      controller: widget.car != null
                          ? null
                          : _model
                              .coolantChanged, //Load bearing code for each of the inputs; this allows either the initial input or the controller to be used first. Both are needed
                      decoration: InputDecoration(
                          labelText:
                ...
                child: SizedBox(
                    ...
                    child: TextFormField(
                      ...
                      controller: widget.car != null
                          ? null
                          : _model
                              .coolantInterval, //Load bearing code for each of the inputs; this allows either the initial input or the controller to be used first. Both are needed
                      decoration: InputDecoration(
                ...
                child: SizedBox(
                    ...
                    child: TextFormField(
                      ...
                      controller: widget.car != null
                          ? null
                          : _model
                              .lastSuspensionInspection, //Load bearing code for each of the inputs; this allows either the initial input or the controller to be used first. Both are needed
                      decoration: InputDecoration(
                          labelText:
                ...
                child: SizedBox(
                    ...
                    child: TextFormField(
                      ...
                      controller: widget.car != null
                          ? null
                          : _model
                              .suspensionInspectionInterval, //Load bearing code for each of the inputs; this allows either the initial input or the controller to be used first. Both are needed
                      decoration: InputDecoration(
                ...
                child: SizedBox(
                    ...
                    child: TextFormField(
                      ...
                      controller: widget.car != null
                          ? null
                          : _model
                              .tireRotationChanged, //Load bearing code for each of the inputs; this allows either the initial input or the controller to be used first. Both are needed
                      decoration: InputDecoration(
                          labelText:
                ...
                child: SizedBox(
                    ...
                    child: TextFormField(
                      ...
                      controller: widget.car != null
                          ? null
                          : _model
                              .tireRotationInterval, //Load bearing code for each of the inputs; this allows either the initial input or the controller to be used first. Both are needed
                      decoration: InputDecoration(
                ...
                child: SizedBox(
                    ...
                    child: TextFormField(
                      ...
                      controller: widget.car != null
                          ? null
                          : _model
                              .tiresChanged, //Load bearing code for each of the inputs; this allows either the initial input or the controller to be used first. Both are needed
                      decoration: InputDecoration(
                          labelText:
                ...
                child: SizedBox(
                    ...
                    child: TextFormField(
                      ...
                      controller: widget.car != null
                          ? null
                          : _model
                              .tiresInterval, //Load bearing code for each of the inputs; this allows either the initial input or the controller to be used first. Both are needed
                      decoration: InputDecoration(
                ...
                child: ElevatedButton(
                  onPressed: () async {
                    setState(() {
                      ...
                      _savedmileage =
                          num.tryParse(_model.carMileage!.text) ?? 0;
                      ...
                      _savedoilinterval =
                          num.tryParse(_model.oilInterval!.text) ?? 5000;
                      _savedtirerotationinterval =
                          num.tryParse(_model.tireRotationInterval!.text) ??
                              5000;
                      _savedbrakesinterval =
                          num.tryParse(_model.brakesInterval!.text) ?? 10000;
                      _savedcoolantinterval =
                          num.tryParse(_model.coolantInterval!.text) ?? 50000;
                      _savedairfilterinterval =
                          num.tryParse(_model.afilterInterval!.text) ?? 50000;
                      _savedsparksinterval =
                          num.tryParse(_model.sparksInterval!.text) ?? 100000;
                      _savedtimingbeltinterval =
                          num.tryParse(_model.timingBeltInterval!.text) ??
                              50000;
                      _savedwaterpumpinterval =
                          num.tryParse(_model.waterPumpInterval!.text) ?? 50000;
                      _saveddrivebeltinterval =
                          num.tryParse(_model.driveBeltInterval!.text) ?? 30000;
                      _savedtransfluidinterval =
                          num.tryParse(_model.transInterval!.text) ?? 30000;
                      _savedtransfilterinterval =
                          num.tryParse(_model.transFilterInterval!.text) ??
                              80085;
                      _savedbrakefluidinterval =
                          num.tryParse(_model.brakeFluidInterval!.text) ??
                              50000;
                      _savedcabinairfilterinterval =
                          num.tryParse(_model.cabinAirFilterInterval!.text) ??
                              100000;
                      _savedfuelfilterinterval =
                          num.tryParse(_model.ffilterInterval!.text) ?? 50000;
                      _savedfuelpumpinterval =
                          num.tryParse(_model.fuelPumpInterval!.text) ?? 50000;
                      _savedtireinterval =
                          num.tryParse(_model.tiresInterval!.text) ?? 30000;
                      _savedSuspensionInspectionInterval = num.tryParse(
                              _model.suspensionInspectionInterval!.text) ??
                          50000;

                      _savedoilchanged =
                          num.tryParse(_model.oilChanged!.text) ?? 0;
                      _savedtirerotationchanged =
                          num.tryParse(_model.tireRotationChanged!.text) ?? 0;
                      _savedbrakeschanged =
                          num.tryParse(_model.brakesChanged!.text) ?? 0;
                      _savedcoolantchanged =
                          num.tryParse(_model.coolantChanged!.text) ?? 0;
                      _savedairfilterchanged =
                          num.tryParse(_model.afilterChanged!.text) ?? 0;
                      _savedsparkschanged =
                          num.tryParse(_model.sparksChanged!.text) ?? 0;
                      _savedtimingbeltchanged =
                          num.tryParse(_model.timingBeltChanged!.text) ?? 0;
                      _savedwaterpumpchanged =
                          num.tryParse(_model.waterPumpChanged!.text) ?? 0;
                      _saveddrivebeltchanged =
                          num.tryParse(_model.driveBeltChanged!.text) ?? 0;
                      _savedtransfluidchanged =
                          num.tryParse(_model.transChanged!.text) ?? 0;
                      _savedtransfilterchange =
                          num.tryParse(_model.transFilterChanged!.text) ?? 0;
                      _savedbrakefluidchanged =
                          num.tryParse(_model.brakeFluidChanged!.text) ?? 0;
                      _savedcabinairfilterchanged =
                          num.tryParse(_model.cabinAirFilterChanged!.text) ?? 0;
                      _savedfuelfilterchanged =
                          num.tryParse(_model.ffilterChanged!.text) ?? 0;
                      _savedfuelpumpchanged =
                          num.tryParse(_model.fuelPumpChanged!.text) ?? 0;
                      _savedtirechanged =
                          num.tryParse(_model.tiresChanged!.text) ?? 0;
                      _savedSuspensionInspection =
                          num.tryParse(_model.lastSuspensionInspection!.text) ??
                              0;
                    });
